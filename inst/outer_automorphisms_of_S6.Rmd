...
$$
(abcd) = (1a)(1b)(1c)(1d)(1a), \qquad b,c,d\neq 1
$$

[there is some further discussion of this identity in
`inst/swap.Rmd`].  We will verify the case $a=4,b=5,c=2,d=9$, viz
$(529)^{(14)}=(4529)$:
...
the cycle includes a `1` [observe that if a cycle _does_ contain a `1`
then it will be in the first position, as per `nicify_cyclist()`].
Numerically:
