...
we might want to keep track of where thet are.  We would say: "at the
start, object $i$ sits in place $i$, $i\in[6]$.  Then, after the move,
object 1 is in place 4, object 2 in place 5, object 3 in place 3, and
so on".  This information is encapsulated by ```as.word(a)```.  In R
