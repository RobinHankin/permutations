...
we might want to keep track of where they are.  We would say: "at the
...
To express the result, `ab_passive` in active language we need to take
the group-theoretic inverse of the composition.  Recalling that
passive transforms are the group-theoretic inverses of the same active
