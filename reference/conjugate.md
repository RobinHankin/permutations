...
#>  [1] FALSE  TRUE  TRUE FALSE FALSE FALSE  TRUE  TRUE FALSE  TRUE FALSE FALSE
#> [13]  TRUE  TRUE FALSE  TRUE FALSE  TRUE FALSE FALSE

rperm(20,3) %~% as.cycle(1:3)
#>  [1] FALSE  TRUE  TRUE  TRUE FALSE FALSE FALSE FALSE FALSE FALSE FALSE  TRUE
